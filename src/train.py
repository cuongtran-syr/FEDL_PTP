...
class FlowerNumPyClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        self.net, _ = train_eval(self.net, self.trainloader, self.x_test, self.y_test, options={'epochs': 40, 'lr': 5 * 1e-4,'eval':False})
...
if __name__ == "__main__":
    ...
    strategy = SaveModelStrategy(
        min_available_clients=len(available_airlines),
